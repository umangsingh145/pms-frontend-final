                    ...
                    {/* <div class='col-md-10 offset=md-1'> */}
                        <div class='row'>
                            {/* <div class='col-md-5 register-rights'> */}
                                ...
                                <div className="col-6 border border-light shadow p-5 mb-7 bg-light bank-left">
                                    <p><h3>Add Bank Account</h3></p>
                            ...
                            {/* <div class='col-md-7 register-right'> */}
                                ...
                                <div className="col-6 border border-light shadow p-5 mb-7 bg-light bank-right">
                                    <p><h3>Update Bank Account</h3></p>
