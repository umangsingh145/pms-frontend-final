...
import Pensioner from './models/Pensioner';
    ...
    const [updatePensionerDetails, setUpdatePensionerDetails] = useState({});
  ...
  return (
    ...
    <div class="regis">
            <div class='container'>
                <div class='row'>
                    {/* <div class='col-md-10 offset=md-1'> */}
                        <div class='row'>
                            ...
                            <div className="col-6 border border-light shadow p-5 mb-7 bg-white pensioner-left">
                         ...
                         <input className="form-control mt-3" type="number" id="accno" name="accno" value={newPensionerObj.accno} onChange={handleAddPensioner} placeholder="Enter accno"/>
                         <input className="form-control mt-3" type="number" id="pensioners_id" name="pensioners_id" value={newPensionerObj.pensioners_id} onChange={handleAddPensioner} placeholder="Enter pensioners Id"/>
                        ...
                        {/* <table className="table table-light table-striped ">
                            ...
                            <div className="col-6 border border-light shadow p-5 mb-7 bg-white pensioner-right">
                          <p><h3>Add Pensioner Details</h3></p>
                          ...
                          <input className="form-control mt-3" type="number" id="accno" name="accno" value={updatePensionerDetails.accno} onChange={handleUpdatePensioner} placeholder="Enter accno"/>
                          <input className="form-control mt-3" type="number" id="pensioners_id" name="pensioners_id" value={updatePensionerDetails.pensioners_id} onChange={handleUpdatePensioner} placeholder="Enter Pensioners_id"/>
                ...
                <li>
                <Link className="link" to="/pension" >NEXT</Link>
                </li>
